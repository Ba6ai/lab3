...
#### В функции numberss вводятся числа. После чего в sumList проход по каждому элементу и превращение последовательности в список (в отличие от List.map, который работает только со списками, Seq.map может работать с чем угодно: массивы, списки, сторки, строчки в .txt файле)
...
#### Найти сумму тех элементов списка, которые начинаются на заданную цифру испольузя Seq.map
